...
CAPABILITIES: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec("google-adk-federation", "Google ADK Federation", "orchestration", "Delegate bounded Tier 0-2 specialist research, web/product, commercial, Workspace-preparation, multimodal and code-review work to a Google ADK swarm over A2A.", "A2A", 2, "provider/free-variable", "remote/local-sidecar", "available", "agent-runtime/google-agent-runtime", "google-a2a", notes="Code path is implemented, but live readiness requires the Google sidecar and provider credentials. Remote output remains unverified until DAWN independently verifies material claims."),
    CapabilitySpec("a2a", "Agent2Agent Protocol", "integration", "Interoperate with independently hosted agent runtimes through a standard agent-to-agent protocol boundary.", "A2A", 2, "open-source", "mixed", "available", "a2aproject/A2A", notes="Protocol availability does not imply any remote agent is reachable or trusted."),
